      ...
      <section className="flex flex-col justify-center items-center bg-slate-950 h-screen">
        <header className='flex flex-col justify-center items-center gap-5'>
          ...
          <section className='flex flex-wrap justify-center items-center gap-2'>
            ...
            <a href="https://www.linkedin.com/in/kanglerian" target='_blank' className='inline-block text-sm text-white hover:text-black hover:bg-white border border-gray-200 px-5 py-2 space-x-1'>
